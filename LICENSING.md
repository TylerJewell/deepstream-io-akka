...
A `LICENSE-deepstream.io` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [deepstreamIO/deepstream.io](https://github.com/deepstreamIO/deepstream.io), Copyright
2019 deepstreamHub GmbH, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../deepstream-io-port/specs/SPEC-001-deepstream-io.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
